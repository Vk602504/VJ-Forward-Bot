...
COMPLETED_BTN = InlineKeyboardMarkup(
  [[
    InlineKeyboardButton(' sᴜᴘᴘᴏʀᴛ ɢʀᴏᴜᴘ ', url='https://t.me/vikashjdbot')
  ],[
    InlineKeyboardButton(' ᴜᴘᴅᴀᴛᴇ ᴄʜᴀɴɴᴇʟ ', url='https://t.me/vikashjdbot')
  ]]
)
CANCEL_BTN = InlineKeyboardMarkup([[InlineKeyboardButton('• ᴄᴀɴᴄᴇʟ', 'vk')]])
